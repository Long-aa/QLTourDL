        ...
        <div className="max-w-7xl mx-auto px-6 h-20 flex items-center justify-between">
          <div className="flex items-center gap-12">
            ...
            <div className="hidden md:flex items-center gap-8">
              ...
              <Link href="#" className="text-sm font-bold hover:text-blue-600 transition-colors">Liên hệ</Link>
            </div>
          </div>
              ...
              <div className="relative group">
                <button className="flex items-center gap-3 p-1.5 hover:bg-gray-50 rounded-full transition-all border border-transparent hover:border-gray-100">
                  ...
                  <div className="hidden md:block text-left pr-2">
                    <p className="text-xs font-bold text-gray-900 leading-tight">Mạnh Cường</p>
                    <p className="text-[10px] text-gray-400 leading-tight">Khách hàng thân thiết</p>
                  </div>
                </button>
                ...
                <div className="absolute right-0 top-full pt-2 w-56 opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-200 z-50">
                  <div className="bg-white rounded-[24px] shadow-2xl border border-gray-100 overflow-hidden py-2">
                    <div className="px-4 py-3 border-b border-gray-50 mb-1">
                      <p className="text-sm font-black text-gray-900">Mạnh Cường</p>
                      <p className="text-[10px] text-gray-400 font-medium">cuong.manh@gmail.com</p>
                    </div>
      ...
      <footer className="bg-gray-50 pt-20 pb-12 border-t border-gray-100">
        <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 md:grid-cols-4 gap-12 pb-16">
          <div className="space-y-6">
            ...
            <p className="text-xs text-gray-400 font-medium leading-relaxed">© 2024 LuxeTravel. Đẳng cấp lữ hành thượng lưu.</p>
          </div>
          <div className="space-y-6">
            ...
            <ul className="space-y-4 text-xs font-bold text-gray-500">
              ...
              <li><Link href="#" className="hover:text-blue-600 transition-colors">Các điểm đến</Link></li>
              <li><Link href="#" className="hover:text-blue-600 transition-colors">Tour mới nhất</Link></li>
            </ul>
          </div>
          <div className="space-y-6">
          ...
          <div className="space-y-6">
            ...
            <ul className="space-y-4 text-xs font-bold text-gray-500">
              <li><Link href="#" className="hover:text-blue-600 transition-colors">Liên hệ hỗ trợ</Link></li>
