    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40 backdrop-blur-sm animate-in fade-in duration-200 p-4">
      <div className="bg-white rounded-2xl shadow-xl w-full max-w-2xl overflow-hidden animate-in zoom-in-95 duration-200">
          ...
          <form className="space-y-5">
            ...
            <div>
              ...
              <input
                ...
                className="w-full px-4 py-2.5 border border-gray-200 rounded-xl focus:ring-2 focus:ring-blue-500/10 focus:border-blue-500 outline-none transition-all text-sm"
              />
            </div>
            ...
            <div className="grid grid-cols-2 gap-6">
              ...
              <div>
                ...
                <div className="relative">
                  <input
                    ...
                    className="w-full pl-4 pr-10 py-2.5 border border-gray-200 rounded-xl focus:ring-2 focus:ring-blue-500/10 focus:border-blue-500 outline-none transition-all text-sm"
                  />
              ...
              {/* Số chỗ */}
              <div>
                <label className="block text-sm font-medium text-gray-700 mb-1.5">Số chỗ</label>
                <input
                  type="number"
              ...
              {/* Ngày khởi hành */}
              <div>
                <label className="block text-sm font-medium text-gray-700 mb-1.5">Ngày khởi hành</label>
                <div className="relative">
                  <input
                    type="text"
            ...
            {/* Thời gian và Trạng thái (conditional layout) */}
            {isEdit ? (
              <div className="grid grid-cols-2 gap-6">
                <div>
            ...
            <div>
              ...
              <div className="border-2 border-dashed border-gray-200 rounded-2xl p-10 flex flex-col items-center justify-center bg-gray-50/30 hover:bg-gray-50 hover:border-blue-200 transition-all cursor-pointer group">
                <div className="w-12 h-12 bg-blue-50 rounded-full flex items-center justify-center mb-4 group-hover:scale-110 transition-transform text-blue-600 shadow-sm">
                  <UploadCloud className="w-6 h-6" />
                </div>
                <p className="text-sm font-semibold text-gray-800">Kéo thả hoặc click để tải ảnh lên</p>
                <p className="text-xs text-gray-400 mt-1.5">Hỗ trợ JPG, PNG (Tối đa 5MB)</p>
              </div>
            </div>
            ...
            <div>
              ...
              <textarea
                ...
                className="w-full px-4 py-3 border border-gray-200 rounded-xl focus:ring-2 focus:ring-blue-500/10 focus:border-blue-500 outline-none transition-all text-sm resize-none"
              ></textarea>
            </div>
          </form>
        </div>
        ...
        <div className="px-6 py-4 border-t border-gray-100 flex justify-end gap-3">
          <button 
            onClick={onClose}
            className="px-6 py-2 border border-gray-200 rounded-xl text-sm font-semibold text-gray-600 bg-white hover:bg-gray-50 hover:border-gray-300 transition-all"
          >
            Hủy
          </button>
          <button 
