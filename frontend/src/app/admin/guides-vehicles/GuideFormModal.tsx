        ...
        <div className="p-10 space-y-10 max-h-[75vh] overflow-y-auto custom-scrollbar dark:bg-gray-900 transition-colors">
          ...
          <div className="space-y-6">
            ...
            <div className="grid grid-cols-2 gap-6">
              ...
              <div className="col-span-1">
                <label className="block text-[10px] font-black text-gray-400 uppercase tracking-widest mb-2 ml-1 dark:text-gray-500">Email nội bộ</label>
                <div className="relative group">
          ...
          <div className="space-y-6 pt-4">
            ...
            <div className="grid grid-cols-2 gap-6">
              ...
              <div className="col-span-1">
                <label className="block text-[10px] font-black text-gray-400 uppercase tracking-widest mb-2 ml-1 dark:text-gray-500">Thị trường trọng điểm</label>
                <div className="relative group">
                  <MapPin className="absolute left-4 top-1/2 -translate-y-1/2 w-5 h-5 text-gray-400 group-focus-within:text-blue-600 transition-colors dark:text-gray-600 dark:group-focus-within:text-blue-400" />
                  <input 
                    type="text" 
              ...
              <div className="col-span-2">
                <label className="block text-[10px] font-black text-gray-400 uppercase tracking-widest mb-2 ml-1 dark:text-gray-500">Ngôn ngữ thông thạo</label>
                <div className="relative group">
